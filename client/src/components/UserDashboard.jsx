...
const UserDashboard = () => {
  ...
  const userBorrowedBooks = useSelector(
    (state) => state.borrow.userBorrowedBooks || [],
  );
  useEffect(() => {
  ...
  const total = totalBorrowedBooks + totalReturnedBooks;
  ...
  return (
    <>
      <main className="relative w-full p-6 pt-28">
        <Header />
        <div className="flex flex-col-reverse xl:flex-row">
          ...
          >
            <div className="flex flex-col gap-7 flex-[4] ">
              ...
              <div className="flex flex-col gap-7 lg:flex-row">
                <div
                  className="flex items-center gap-3 bg-white p-5 
                max-h-[120px] overflow-y-hidden rounded-lg transition
                hover:shadow-inner duration-300 "
                >
                  <span className="w-[2px] bg-black h-20 lg:h-full"></span>
                  <span
                  ...
                  <p className="text-lg xl:text-xl font-semibold">
                    LET'S BROWSE BOOKS IN OUR INVENTORY
                  </p>
                </div>
                <img
                  src={logo_with_title}
            ...
            <div
              className="bg-white text-lg p-7 sm:text-xl xl:text-3xl 2xl:text-4xl
            min-h-52 font-semibold relative flex-[3] flex justify-center items-center
            rounded-2xl"
            >
              <h4 className="overflow-hidden text-center px-4">
          ...
          {/* RIGHT SIDE */}
          <div
            className="flex-[2] flex-col gap-7 lg:flex-row flex lg:items-center
